from Media_FinaL_Sem_Inoculo import temperatura_biodig, recirculacao, drenagem, producao_biogas, ph_inferior, ph_superior
...
statistic4, p_value4 = stats.shapiro(producao_biogas)
